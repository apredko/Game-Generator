...
"rebuilding after the fire", "a street brawl", "time travel but only to the most awkward moments in lived existance", "digging your own grave", "your twilight years", "going to the hairdresser", "acting out all the fears your parents worried about",
...
"the universe opening up as a giant eye and screaming at you in tongues on a chilly Tuesday afternoon", "a thousand eyes blinking in unison", "gracing the public with your presence","being seen by someone you\'re avoiding",
...
"loosing yourself during a trip", "trudging down the mountain", "your mother being a literal washing mashine", "resting your head on the cold ground", "finding hapiness",
"learning to do something with your hands", "scratching the surfaceof something far deeper than you realized", "covering pop songs", "one hit wonder bands covering each other songs",
"a picture you thought you lost", "oven mitt hands", "a BBQ with your friends on the beach", "watching the sunset", "having kids", "dyeing yourself purple accidentally", "running out of time",
"an eating contest", "butt dialing your ex", "catching sunlight", "making friends with your local bartender", "first dates", "trying to scratch an itch you can\'t reach", "falling in love", "getting a cat",
"making friends with every cat on the block", "moving out of your parent\'s house", "moving back in with your folks", "a stranger on the bus", "Sonic fanfiction", "where all the crows went", "vials of your friends\' blood",
"summoning a demon because you're lonely", "making music with your friends", "having dinner and working on projects with a friend", "makin\' stuff","rattlesnakes",
"the dirst time you knew love", "the tiny quirks your girlfriend has that make you fall more in love with her", "Shakespearean prose", "how Romeo and Juliet could\'ve probably taken some better steps", 
"getting catcalled", "killing your enemies", "staying hydrated", "opening a cafe", "finally getting a diagnosis", "riding your bike", "laneway houses", "growing grapes and making wine", "running from the corpses",
"a biological apocalypse", "living in a trailer", "hiding from protective services", "entering your selfie in Google Dream to find your true self", "taking pictures of stray cats", "sewing the perfect backpack",
"peacocks in competition with each other to see who is the most beautiful", "making yourself beautiful", "leaving your phone behind the bar to charge and hoping for the best", "networking at a fancy event without letting on how big of a slob you are",
"99 bugs in the code", "glassblowing", "surviving the night in the city", "an extremely detailed walkthrough of a mundane task", "trying to come up with over a thousand unique things", "cleaning a deer skull",
"staring a petting zoo", "being curious", "the butterfly life cycle", "the water cycle", "trying to make a mark in the world before you die", "impossible things", "Shenzhen", "the place opposite from you on the planet",
"the day exsactly half a year from your birthday", "forging documents", "going to a religious service you have no idea what the protocol is", "being there for a friend in need","the colour blue and the history of language around it",
"being made of ice", "running multiple Adobe programs and trying to not have your computer crash", "historically accurate make up tutorials", "mercury","your favourite internet personality","a night market", "a night parade of 100 demons",
"learning how to cook from your grandmother", "a heatwave hitting almost 50C", "a three eyed raven sitting right outside your door whispering sweet nothings", "so many birds they black out the sky","a friendly parrot",
"using carrots to rot cars", "competitive pun making", "making up new constellations", "a fairytale romance gone wrong", "never giving up, never giving in", "bloom effect turned up to 2006 levels", "getting to know someone you have nothing in common with",
"the library as a community space", "speculating what will happen in the next 30 seconds", "a length of rope the same height as you", "making friends with local wildlife so they\'ll steal things for you", "getting in a fist fight",
"being the only driver in a group full of queers", "earwigs", "new leaves", "sunlight", "moonlight", "a single screw, five paper clips, and a warped piece of particle board", "scavanging materials", "using art as a way of working through your problems",
"your favourite muscician", "finding the best of bnoth worlds", "trying to avoid eye contact with someone you know across the cafe", "trying to avoid eye contact with someone you know across the bar", "counting sheep", "the gentle rocking of a dock", 
"taking care of your boss\' dog", "an emergency visit to the ER", "making desserts", "making deserts", "a rainforest hidden in the mountains", "an overcrowded pet store", "grass growing", "leather binding a tomb accounting your entire life to date",
"gargoyles", "trying to guess who likes cilantro and who doesn\'t", "using the ocean currents to sail across the world","playing mafia","watching your favourite movie with a friend and trying not to ruin it by being too excited", "borking", "hailing a cab but instead a small child riding a german shepherd stops",
"vaping"];
